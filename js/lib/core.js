        ...
        * });
        ...
        $wb.Class = function (name, opts) {
            ...
            clz.prototype.__deleteLater = function () {
                ...
                if (this instanceof $wb.core.Events) {
                    this.trigger('__delete');
                }
        ...
        $wb.core.Events = $wb.Class('Events',
             ...
             */
            {
                 ...
                 * @param {Object} listener Object that is doing the listening. Will automatically remove listener when this object is deleted
                 */
                bind: function (evt, handler, listener) {
                    if (!this._bindings[evt])
                        this._bindings[evt] = [];
                    this._bindings[evt].push(handler);
                    var me = this;
                    if (listener && listener.bind && evt !== '__delete') {
                        listener.bind('__delete',function() {
                            me.unbind(evt, handler);
                        },this);
                    }
                    return this;
                },
